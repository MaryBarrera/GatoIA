...
public class Gato extends javax.swing.JFrame implements Runnable {
    ...
    /* 0 Empate, 1 gana jugador 1 y 2 si gana jugador 2*/
    ...
    private void initComponents() {
        ...
        fondo.setBounds(130, 0, 460, 390);

        mnuJuego.setText("Juego");

        mnuIniciar.setText("Nuevo Juego");
        mnuIniciar.setName(""); // NOI18N
        ...
        setSize(new java.awt.Dimension(618, 462));
